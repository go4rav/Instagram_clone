...
const HomePage = () => {
    ...
    <section class="fixed py-6 px-3 bg-black w-[245px] h-[100%] border-r-[1px] border-r-zinc-800">
      ...
      <nav>
        <ul class="h-[100%] flex flex-col text-base  space-y-4 py-7 text-white ">
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <a href="#">
                <li class="pl-3 flex">
                  <svg aria-label="Home" class="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                    viewBox="0 0 24 24" width="24">
                    <path
                      d="M22 23h-6.001a1 1 0 0 1-1-1v-5.455a2.997 2.997 0 1 0-5.993 0V22a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V11.543a1.002 1.002 0 0 1 .31-.724l10-9.543a1.001 1.001 0 0 1 1.38 0l10 9.543a1.002 1.002 0 0 1 .31.724V22a1 1 0 0 1-1 1Z">
                    </path>
                  </svg>
                  <p class="ml-4  text-[16px] font-sans">Home</p>
                </li>
              </a>
            </button>
          </div>
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li class="pl-3 flex">
                <svg aria-label="Search" class="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                  viewBox="0 0 24 24" width="24">
          ...
          <div class="flex cursor-pointer rounded-3xl py-2  active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li class="pl-3 flex">
                <svg aria-label="Reels" class="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                  viewBox="0 0 24 24" width="24">
                ...
                <p class="font-sans text-[16px]  ml-4">Reels</p>
              </li>
            </button>
          </div>
          <div class=" flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button id="btn-msg">
              <a href="#">
                <li class="flex pl-3 ">
                  <i class=" text-2xl  relative mr-4">
                ...
                <button
                  class="rounded-full top-[329px] text-center items-center right-[183px] absolute h-[18px] w-[23px] bg-red-600 text-white text-xs">
                  12
                </button>
              </a>
            </button>
          ...
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li class="pl-3 flex">
                ...
                <p class="ml-4 font-sans text-[16px]">
                  Notifications
                </p>
              </li>
            </button>
          ...
          <div class="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10 ">
            <button onClick = {()=>setIsModalOpen(true)}>
              <li class="pl-3 flex">
                ...
                <p class="ml-4 font-sans text-[16px]">Create</p>
              </li>
            </button>
          </div>
...
//                         fetchPosts();        // Refresh the feed
      ...
      <div class="flex cursor-pointer mt-[75px] text-xl rounded-3xl py-2 hover:bg-gray-50 hover:bg-opacity-10">
        ...
        <span>
          <p class="text-white text-base mt-1">Mais</p>
        </span>
      </div>
    </section>
